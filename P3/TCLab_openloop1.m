...
T = 8000; % experiment duration [s] -> 2 horas e 13 minutos 
Ts = 5; % sampling period [s]
N = T/Ts; % number of samples to collect -> 1400 samples

% Phase A
u(1, 1:400) = 45; % wait 1000 + 1000 seconds to ensure steady state before starting 
...
save(['openloop_data_1',timestr,'.mat'],'y','u','t');
